...
@section('content')
    <div class="container-fluid px-4">
        ...
        @endif
        <div class="row">
            <form action="{{route('comunidadUpdate', $comunidad->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="container">
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ $comunidad->titulo }}" name="title"
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ $comunidad->video }}" name="video"
                                    aria-describedby="titleError" placeholder="Ingrese un título" maxlength="150">
                                @if ($errors->has('video'))
                                    <small id="videoError"
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="date" id="fecha" name="fecha" value="{{ $comunidad->fecha }}">
                            </div>
                        </div>
                    </div>
                </div>
