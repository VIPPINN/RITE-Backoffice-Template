...
@section('content')
    <div class="container-fluid px-4">
        ...
        @endif
        <div class="row">
            <form action="{{ route('agendaUpdate',$agenda->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="container">
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ $agenda->titulo }}" name="title"
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ $agenda->descripcion }}" name="descripcion"
                                    aria-describedby="titleError" placeholder="Ingrese un título" maxlength="150">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <img src="{{ asset(env('PATH_FILES')) }}/Comunidad/{{ $agenda->imagen }}" width="60">
                            ...
                            <div class="form-group">
                                <select name="modalidad" id="modalidad" style="width:300px">
                                    ...
                                    @foreach ($modalidades as $index => $modalidad)
                                        @if($agenda->idModalidad == $modalidad->id)
