...
@section('content')
    <div class="container-fluid px-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('formacionIndex') }}">Inicio</a></li>
        ...
        @endif
        <div class="row">
            <form action="{{ route('formacionUpdate',$formacion->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="container">
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ $formacion->titulo }}" name="title"
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ $formacion->descripcion }}" name="descripcion"
                                    aria-describedby="titleError" placeholder="Ingrese un título" maxlength="150">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <img src="{{ asset(env('PATH_FILES')) }}/Comunidad/{{ $formacion->imagen }}" width="60">
                            ...
                            <div class="form-group">
                                <select name="modalidad" id="modalidad" style="width:300px">
                                    ...
                                    @foreach ($modalidades as $index => $modalidad)
                                        @if($formacion->idModalidad == $modalidad->id)
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="date" id="fecha" name="fecha" value="{{ $formacion->fecha }}">
                                @if ($errors->has('fecha'))
                                <small id="linkError"
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input type="time" id="hora" name="hora" value="{{ $formacion->hora }}">
                                @if ($errors->has('hora'))
                                <small id="linkError"
