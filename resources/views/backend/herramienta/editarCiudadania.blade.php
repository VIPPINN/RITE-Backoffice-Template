...
@section('content')
    <div class="container-fluid px-4">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('ciudadania') }}">Inicio</a></li>
        ...
        @endif
        <div class="row">
            <form action="{{ route('ciudadaniaUpdate', $herramienta->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <textarea class="descripcion-textarea" name="descripcion" maxlength="2000" placeholder="Ingrese el texto...">{{ $herramienta->descripcion }}</textarea>
                                {{ csrf_field() }}
                                @if ($errors->has('title'))
                                    <small id="titleError" class="form-text text-danger">Se ha producido un error al
                                        ingresar el título.</small>
                            ...
                            <div class="form-group">
                                <select name="tipo" id="tipo" style="width:300px">
                                    ...
                                    @foreach ($herramientaTipo as $index => $tipo)
                                        @if ($tipo->descripcion == $herramienta->descripcionTipo)
