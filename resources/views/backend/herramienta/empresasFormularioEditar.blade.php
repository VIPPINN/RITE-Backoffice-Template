...
<div class="container-fluid px-4">
    ...
    @endif
    <div class="row">
        <form action="{{ route('formularioEmpresaUpdate', $formulario->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            <select name="tipo" id="tipo" style="width:300px">
                                ...
                                @if($empresa->descripcion == $formulario->descripcion)
                                <option value="{{$empresa->id}}" selected>{!!$empresa->descripcion!!}</option>
                                @else
