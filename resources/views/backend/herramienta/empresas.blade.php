...
@section('content')
    ...
    <div class="container-fluid px-4">
        <h1 class="mt-4">Herramientas Empresas</h1>
        ...
        <div class="contenedor-botones-superiores">
            <div class="row mt-3 mb-3">
                <div class=" text-right">
                    <a class="btn btn-success" href="{{ route('empresaHerramientaCrear') }}" title="Crear Herramienta">
            ...
            <div class="row mt-3 mb-3">
                <div class="text-right">
                    <a class="btn btn-primary" href="{{ route('empresaHerramientaListado') }}" title="Crear Herramienta">
                        <i class="fas fa-plus-circle"></i>
                        FORMULARIOS
                    </a>
                </div>
                            ...
                            <td>
                                <span class="text-center ml-2">
                                    <form id="form_cuestionario_{{ $herramienta->id }}"
                                        action="{{ route('empresaHerramientaBorrar', $herramienta->id) }}" method="POST">

                                        <a class="badge bg-warning"
                                            href="{{ route('empresaHerramientaEditar', $herramienta->id) }}"><i
