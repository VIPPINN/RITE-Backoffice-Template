...
<div class="container-fluid px-4">
    <h1 class="mt-4">Origen de Recurso</h1>
    ...
    <div class="row">
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <span>{!! $origenRecurso->titulo !!}</span>
                        @if ($errors->has('title'))
            ...
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <span>{!! $origenRecurso->descripcion !!}</span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm">
                    <div class="form-group">
                        <label for="text"><i><strong>Status:</strong></i></label><br>

                        @if ($origenRecurso->estado == '1')
