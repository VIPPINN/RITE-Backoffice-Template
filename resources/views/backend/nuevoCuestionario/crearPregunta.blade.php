...
<div class="container-fluid px-4">
    ...
    @endif
    <div class="row">
        <form action="{{ URL::to('/backend/cuestionarios/guardarPregunta')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="row">
                    <div class="col-sm">
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombrePdf"/></br>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input style="width:100px" value="{{$numeromaximo}}" id="numero" name="numero" placeholder="0"><br>
