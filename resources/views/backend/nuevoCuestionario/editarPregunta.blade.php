...
<div class="container-fluid px-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ URL::to('/backend/cuestionarios/temas/preguntas/'. $pregunta->idTema)}}">Inicio</a></li>
    ...
    @endif
    <div class="row">
        <form action="{{ URL::to('/backend/cuestionarios/editarPregunta')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="container">
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <textarea id="pregunta" name="pregunta" placeholder="Ingrese pregunta">{!!$pregunta->pregunta!!}</textarea>
                            {{ csrf_field() }}
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="respuestaDisparadorSubpregunta" id="respuestaDisparadorSubpregunta" class="form-control">
                                @if($pregunta->respuestaDisparadorSubpregunta == 'SI')
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="requiereEvidencia" id="requiereEvidencia" class="form-control">
                                @if($pregunta->requiereEvidencia == 'SI')
                                <option value="SI" selected>SI</option>
                                <option value="NO">NO</option>
                                @else
                                <option value="SI">SI</option>
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <textarea id="opcionesSugeridas" name="opcionesSugeridas" placeholder="...">{!!$pregunta->opcionesSugeridas!!}</textarea>
                            {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombrePdf"/>{!!$pregunta->nombrePDF!!}</br>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="idTipoPregunta" id="idTipoPregunta" class="form-control">
                                ...
                                @if($pregunta->idTipoPregunta == $tipoPregunta->id)
                                <option value="{!!$tipoPregunta->id!!}" selected>{!!$tipoPregunta->descripcion!!}</option>
                                @else
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="idPreguntaPadre" id="idPreguntaPadre" class="form-control">
                                <option value="">Seleccione...</option>
                                @foreach ($preguntas as $index => $pregunta2)
                                @if($pregunta->idPreguntaPadre == $pregunta2->id)
                                <option value="{!!$pregunta2->id!!}" selected>{{$pregunta2->numero}} - {!!$pregunta2->pregunta!!}</option>
                                @else
                                <option value="{!!$pregunta2->id!!}">{{$pregunta2->numero}} - {!!$pregunta2->pregunta!!}</option>
                                @endif
                                @endforeach
                            </select>
                            {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input style="width:100px" value="{!!$pregunta->numero!!}" id="numero" name="numero" placeholder="0"><br>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input style="width:100px" value="{{ $pregunta->cantidadMesesVencimiento }}" id="cantidadMesesVencimiento" name="cantidadMesesVencimiento" placeholder="0"><br>
            ...
            <div class="container">
                ...
                <label for="" class="select-impacto-categoria-gurpo">Impacto segun grupo y categoria</label>
                @foreach($gruposEntidad as $indexGrupos => $grupoEntidad)
                <p class="grupos">{!!$grupoEntidad->descripcion!!}</p>
                @foreach($categoriasEntidad as $indexCategoria => $categoraEntidad)
                <div class="select-grupo-categoria">
                    <p class="categorias">{!!$categoraEntidad->descripcion!!}</p>
                    <div class="col-sm-4">
                        <div class="form-group" id="opcionImpacta-div">
                        @foreach($preguntaNivel as $indexNivel => $pregNivel)
                            @if($pregNivel->idGrupoEntidad == $grupoEntidad->id && $pregNivel->idCategoriaEntidad == $categoraEntidad->id)

                            @if($pregNivel->idNivel == 0)
                            <select name="opcionImpacta_{!!$grupoEntidad->id!!}_{!!$categoraEntidad->id!!}" id="opcionImpacta" class="form-control grupo-categoria">
    ...
    <script>
        ...
        $("#numero").numeric();
        $("#cantidadMesesVencimiento").numeric();

        function mostrarOpciones() {
            impacta = document.getElementById("impactoNivelAvance").value;
            opcionImpacta = document.getElementById("opcionImpacta-div");
            if (impacta == 0) {
                opcionImpacta.style.display = "none";
            } else {
                opcionImpacta.style.display = "block";
            }
        }
    </script>
