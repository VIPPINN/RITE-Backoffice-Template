...
<div class="container-fluid px-4">
  ...
  @endif
  <div class="row">
    <form action="{{ URL::to('/backend/cuestionarios/guardarOpcion')}}" method="POST">
      @csrf
      ...
      <div class="container-noMargin-left">
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <label for="descripcion">Opción</label>
              <input type="text" class="form-control" id="descripcion" name="descripcion" aria-describedby="titleError" placeholder="...">
