...
<div class="container-fluid px-4">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('tipoEntidad.index')}}">Inicio</a></li>
  ...
  @endif
  <div class="row">
    <form action="{{ route('tipoEntidad.update', $tipoEntidad->id) }}" method="POST">
      @csrf
      @method('PUT')
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <select name="idGrupoEntidad" id="idGrupoEntidad" class="form-control" >
                <option value="">Seleccione...</option>
                  @foreach ($gruposEntidad as $index => $grupoEntidad)
                    @if($tipoEntidad->idGrupoEntidad == $grupoEntidad->id)
              ...
              @if ($errors->has('idGrupoEntidad'))
                <small id="titleError" class="form-text text-danger">{{ $errors->first('idGrupoEntidad') }}</small>
              @endif
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="{{ $tipoEntidad->descripcion }}" id="descripcion" name="descripcion" aria-describedby="titleError" placeholder="...">
          ...
          <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="{{ $tipoEntidad->orden }}" id="orden" name="orden" aria-describedby="titleError" placeholder="...">
              @if ($errors->has('orden'))
