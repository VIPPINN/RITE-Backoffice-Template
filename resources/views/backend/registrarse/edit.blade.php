...
@section('content')
    <div class="container-fluid px-4">
        ...
        @endif
        <div class="row">
            <form action="{{ route('registrarse.update', $registro->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="container">
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <input id="texto" class="form-control" 
                                    name="title" aria-describedby="titleError" value="{{ $registro->titulo }}"
                                    maxlength="150">
                                @if ($errors->has('title'))
                                    <small id="titleError"
                        ...
                        <div class="col-sm">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="editor"
                                    name="texto" aria-describedby="textoError">{{ $registro->texto }}</textarea>
